...
//        List<String> dict = List.of("a", "b", "c");
        ...
        int res = new WordLadder127().ladderLength(
    ...
    private void addToMap(List<String> wordList, int i1, String w1) {
        ...
        for (int i2 = 0; i2 < i1; i2++) {
            ...
            if (pair(w1, w2)) {
                ...
                //dict[i1][i2] = 1;
                //dict[i2][i1] = 1;
                map.computeIfAbsent(i1, (k) -> new ArrayList<>()).add(i2);
                map.computeIfAbsent(i2, (k) -> new ArrayList<>()).add(i1);
            }
        }
    }

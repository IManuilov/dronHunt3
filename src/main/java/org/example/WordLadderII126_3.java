...
public class WordLadderII126_3 {
...
//        List<String> dict = List.of("hot","dot","dog","lot","log");
        ...
        List<List<String>> res = new WordLadderII126_3().findLadders(
    ...
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        while (!found) {
            ...
            for (Node cur : curLayer.values()) {
                List<String> connected = map.get(cur.str);
                ...
                for (String s : connected) {
                    ...
                    nextLayer.computeIfAbsent(s, (k) -> new Node(s)).prev.add(cur);
                }
